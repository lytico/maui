...
namespace Microsoft.Maui.Controls.Compatibility.Platform.GTK.Cells
{
	public class EntryCellRenderer : CellRenderer
	{
		...
		{
			var entryCell = (Microsoft.Maui.Controls.EntryCell)item;
		...
		protected override void CellPropertyChanged(object sender, PropertyChangedEventArgs args)
		{
			...
			var entryCell = (Microsoft.Maui.Controls.EntryCell)gtkEntryCell.Cell;

			if (args.PropertyName == Microsoft.Maui.Controls.EntryCell.LabelProperty.PropertyName)
			{
				gtkEntryCell.Label = entryCell.Label ?? string.Empty;
			}
			else if (args.PropertyName == Microsoft.Maui.Controls.EntryCell.LabelColorProperty.PropertyName)
			{
				gtkEntryCell.LabelColor = entryCell.LabelColor.ToGtkColor();
			}
			else if (args.PropertyName == Microsoft.Maui.Controls.EntryCell.TextProperty.PropertyName)
			{
				gtkEntryCell.Text = entryCell.Text ?? string.Empty;
			}
			else if (args.PropertyName == Microsoft.Maui.Controls.EntryCell.PlaceholderProperty.PropertyName)
			{
		...
		{
			((Microsoft.Maui.Controls.EntryCell)Cell).Text = text ?? string.Empty;
		}

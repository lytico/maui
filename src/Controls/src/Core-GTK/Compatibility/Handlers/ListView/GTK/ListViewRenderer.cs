...
{
	public class ListViewRenderer : ViewRenderer<Microsoft.Maui.Controls.ListView, ListViewControl>
	{
		...
		public static CommandMapper<Frame, FrameRenderer> CommandMapper
			= new CommandMapper<Frame, FrameRenderer>();
		...
		Microsoft.Maui.Controls.ListView ListView => Element;
		...
		protected override void OnElementPropertyChanged(object sender, PropertyChangedEventArgs e)
		{
			...
			if (e.PropertyName == Microsoft.Maui.Controls.ListView.IsGroupingEnabledProperty.PropertyName)
				UpdateGrouping();
			//else if (e.PropertyName == nameof(ListView.HeaderElement))
			//	UpdateHeader();
			//else if (e.PropertyName == nameof(ListView.FooterElement))
			//	UpdateFooter();
			else if (e.PropertyName == Microsoft.Maui.Controls.ListView.RowHeightProperty.PropertyName)
				UpdateRowHeight();
				...
				UpdatePullToRefreshEnabled();
			else if (e.PropertyName == Microsoft.Maui.Controls.ListView.SelectedItemProperty.PropertyName)
				UpdateSelectedItem();
		}
		...
		private TextCell CreateEmptyHeader()
		{
			return new TextCell();
				//string.Empty,
		...
		private void OnItemTapped(object sender, ItemTappedEventArgs args)
		{
			...
			if (index > -1)
			{
				Element.NotifyRowTapped(index, cell: null, isContextmenuRequested: args.GtkMouseButton == GtkMouseButton.Right);
			}
		}
	}
}

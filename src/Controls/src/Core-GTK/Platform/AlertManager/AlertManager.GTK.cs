...
namespace Microsoft.Maui.Controls.Platform
{
	internal partial class AlertManager
	{
		...
		internal sealed class AlertRequestHelper : IDisposable
		{
			...
			internal AlertRequestHelper(MauiGTKWindow window, IMauiContext mauiContext)
			{
				Window = window;
...
#pragma warning restore CS0618 // Type or member is obsolete
			...
			public MauiGTKWindow Window { get; }
...
#pragma warning restore CS0618 // Type or member is obsolete
			...
			void OnAlertRequested(Page sender, AlertArguments arguments)
			{
				...
				var result = alertDialog.RunAlertDialog((Gtk.Window)Window, arguments);

...
namespace Microsoft.Maui.Controls.Handlers.Items
{
	public class MauiCarouselRecyclerView : MauiRecyclerView<CarouselView, ItemsViewAdapter<CarouselView, IItemsViewSource>, IItemsViewSource>, IMauiCarouselRecyclerView
	{
		...
		public MauiCarouselRecyclerView(Func<IItemsLayout> getItemsLayout, Func<ItemsViewAdapter<CarouselView, IItemsViewSource>> getAdapter) : base(getItemsLayout, getAdapter)
		{

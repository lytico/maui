...
namespace Microsoft.Maui.Controls.Handlers.Items
{
		...
		where TItemsViewSource : IItemsViewSource
	{
		...
		internal CarouselViewAdapter(CarouselView itemsView, Func<View, ItemContentView> createItemContentView = null) : base(itemsView as TItemsView, createItemContentView)
		{

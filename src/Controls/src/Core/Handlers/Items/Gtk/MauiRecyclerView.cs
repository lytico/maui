...
namespace Microsoft.Maui.Controls.Handlers.Items
{
		...
		where TItemsViewSource : IItemsViewSource
	{
		...
		public MauiRecyclerView(Func<IItemsLayout> getItemsLayout, Func<TAdapter> getAdapter) : base()
		{
		...
		protected virtual LayoutManager SelectLayoutManager(IItemsLayout layoutSpecification)
		{
			switch (layoutSpecification)
			{
				...
				case LinearItemsLayout listItemsLayout:
					var orientation = listItemsLayout.Orientation == ItemsLayoutOrientation.Horizontal ? LinearLayoutManager.Horizontal : LinearLayoutManager.Vertical;
		...
		{
			var gridLayoutManager = new GridLayoutManager(gridItemsLayout.Span,
				gridItemsLayout.Orientation == ItemsLayoutOrientation.Horizontal ? LinearLayoutManager.Horizontal : LinearLayoutManager.Vertical,
				false);
	...
	public class ItemTouchHelper
	{
		...
		public class Callback
		{
			...
			public virtual int GetMovementFlags(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder)
			{
				throw new NotImplementedException();
			}

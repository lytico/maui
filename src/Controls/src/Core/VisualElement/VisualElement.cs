...
After:
		...
		static object CoerceInputTransparentProperty(BindableObject bindable, object? oldValue, object? newValue)
*/
...
After:
		static void OnWindowChanged(BindableObject bindable, object oldValue, object newValue)
*/
		static void OnIsEnabledPropertyChanged(BindableObject bindable, object value)
		{
...
After:
		...
		static void OnInputTransparentPropertyChanged(ITypeDescriptorContext context, Type sourceType)
*/
...
#nullable disable
		...
		public class VisibilityConverter : TypeConverter
		{
			public override bool CanConvertFrom(BindableObject bindable, 
/* Unmerged change from project 'Controls.Core(net8.0)'
Before:
			public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
			{

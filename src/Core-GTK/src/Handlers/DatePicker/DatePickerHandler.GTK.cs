...
namespace Microsoft.Maui.Handlers
{
	public partial class DatePickerHandler : ViewHandler<IDatePicker, DatePicker>
	{
		...
		protected override DatePicker CreatePlatformView(IView picker)
		{
			var mauiDatePicker = new DatePicker();
		...
		protected override void ConnectHandler(DatePicker platformView)
		{
		...
		//protected override void DisconnectHandler(DatePicker platformView)
		//{
		//	//if (_dialog != null)
		//	//{
		//	//	_dialog.Hide();

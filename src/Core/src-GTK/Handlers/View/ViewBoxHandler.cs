...
{
	public abstract partial class ViewBoxHandler : ElementHandler, IViewHandler
	{
...
//#endif
		...
		protected ViewBoxHandler(IPropertyMapper mapper, CommandMapper? commandMapper = null)
		...
		void ConnectingHandler(PlatformView? platformView)
		{
		...
		void DisconnectingHandler(PlatformView platformView)
		{
		...
		static void MappingSemantics(IViewHandler handler, IView view)
		{
		...
		static void MappingFrame(IViewHandler handler, IView view)
		{

...
{
	public abstract partial class AltViewHandler<TVirtualView, TPlatformView> : AltViewHandler, IAltViewHandler
...
#endif
	{
		...
		IView? IAltViewHandler.VirtualView => base.VirtualView;
		...
		public static Func<AltViewHandler<TVirtualView, TPlatformView>, TPlatformView>? PlatformViewFactory { get; set; }

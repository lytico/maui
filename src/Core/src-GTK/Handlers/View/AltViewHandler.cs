...
{
	public abstract partial class AltViewHandler : ElementHandler, IAltViewHandler
	{
		public static IPropertyMapper<IView, IAltViewHandler> ViewMapper =
#if ANDROID
			// Use a custom mapper for Android which knows how to batch the initial property sets
			new AndroidBatchPropertyMapper<IView, IAltViewHandler>(ElementMapper)
#else
			new PropertyMapper<IView, IAltViewHandler>(ElementHandler.ElementMapper)
#endif
			{
				...
				[nameof(IAltViewHandler.ContainerView)] = MapContainerView,
		...
		public static CommandMapper<IView, IAltViewHandler> ViewCommandMapper = new()
		{
		...
		protected AltViewHandler(IPropertyMapper mapper, CommandMapper? commandMapper = null)
		...
		object? IAltViewHandler.ContainerView => ContainerView;
		...
		public static void MapWidth(IAltViewHandler handler, IView view)
		{
			((PlatformView?)handler.PlatformView)?.UpdateWidth(view);
		}

		public static void MapHeight(IAltViewHandler handler, IView view)
		{
			((PlatformView?)handler.PlatformView)?.UpdateHeight(view);
		}

		public static void MapMinimumHeight(IAltViewHandler handler, IView view)
		{
			((PlatformView?)handler.PlatformView)?.UpdateMinimumHeight(view);
		}

		public static void MapMaximumHeight(IAltViewHandler handler, IView view)
		{
			((PlatformView?)handler.PlatformView)?.UpdateMaximumHeight(view);
		}

		public static void MapMinimumWidth(IAltViewHandler handler, IView view)
		{
			((PlatformView?)handler.PlatformView)?.UpdateMinimumWidth(view);
		}

		public static void MapMaximumWidth(IAltViewHandler handler, IView view)
		{
			((PlatformView?)handler.PlatformView)?.UpdateMaximumWidth(view);
		}

		public static void MapIsEnabled(IAltViewHandler handler, IView view)
		{
			((PlatformView?)handler.PlatformView)?.UpdateIsEnabled(view);
		}

		public static void MapVisibility(IAltViewHandler handler, IView view)
		{
		...
		public static void MapBackground(IAltViewHandler handler, IView view)
		{
		...
		public static void MapFlowDirection(IAltViewHandler handler, IView view)
		{
			((PlatformView?)handler.PlatformView)?.UpdateFlowDirection(view);
		}

		public static void MapOpacity(IAltViewHandler handler, IView view)
		{
			if (handler.HasContainer)
		...
		public static void MapAutomationId(IAltViewHandler handler, IView view)
		{
			((PlatformView?)handler.PlatformView)?.UpdateAutomationId(view);
		}

		public static void MapClip(IAltViewHandler handler, IView view)
		{
		...
		public static void MapShadow(IAltViewHandler handler, IView view)
		{
		...
		static partial void MappingSemantics(IAltViewHandler handler, IView view);

		public static void MapSemantics(IAltViewHandler handler, IView view)
		{
			MappingSemantics(handler, view);
			((PlatformView?)handler.PlatformView)?.UpdateSemantics(view);
		}

		public static void MapInvalidateMeasure(IAltViewHandler handler, IView view, object? args)
		{
			(handler.PlatformView as PlatformView)?.InvalidateMeasure(view);
		}

		public static void MapContainerView(IAltViewHandler handler, IView view)
		{
			if (handler is ViewHandler viewHandler)
				handler.HasContainer = viewHandler.NeedsContainer;
		}

		public static void MapBorderView(IAltViewHandler handler, IView view)
		{
		...
		public static void MapFrame(IAltViewHandler handler, IView view, object? args)
		{
			MappingFrame(handler, view);
		}

		public static void MapZIndex(IAltViewHandler handler, IView view, object? args)
		{
		...
		public static void MapFocus(IAltViewHandler handler, IView view, object? args)
		{
		...
		public static void MapInputTransparent(IAltViewHandler handler, IView view)
		{
#if ANDROID
		...
		public static void MapUnfocus(IAltViewHandler handler, IView view, object? args)
		{
			((PlatformView?)handler.PlatformView)?.Unfocus(view);
		}

		static void UpdateHasContainer(IAltViewHandler handler, bool definitelyNeedsContainer)
		{

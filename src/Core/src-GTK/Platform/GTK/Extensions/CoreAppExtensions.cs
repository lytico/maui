...
namespace Microsoft.Maui.Platform
{
	internal static class CoreAppExtensions
	{
		...
		public static IWindow GetWindow(this IWindow winRef)
		{
#if NETSTANDARD
			if (MauiGTKApplication.CurrentApp != null)
			{
				foreach (var window in MauiGTKApplication.CurrentApp.Application.Windows)
				{
					if (window?.Handler?.PlatformView is Gtk.Window win && win == MainWindow)
						return window;
				}
			}
#endif

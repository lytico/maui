...
public sealed class PrismAppBuilder
{
    ...
    internal PrismAppBuilder(IContainerExtension containerExtension, Microsoft.Maui.Hosting.MauiAppBuilder builder)
    {
        ...
        containerExtension.RegisterSingleton<Microsoft.Maui.Hosting.IMauiInitializeService, PrismInitializationService>();

        ConfigureViewModelLocator();
    }

    public Microsoft.Maui.Hosting.MauiAppBuilder MauiBuilder { get; }
